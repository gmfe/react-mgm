...
return n.state={active:!1},n.handleClick=n.handleClick.bind(n),n.handleMouseEnter=n.handleMouseEnter.bind(n),n.handleMouseLeave=n.handleMouseLeave.bind(n),n.handleBodyClick=n.handleBodyClick.bind(n),n.timer=null,n.refPopup=null,n}return i(t,e),l(t,[{key:"componentDidMount",value:function(){window.document.body.addEventListener("click",this.handleBodyClick)}},{key:"componentWillUnmount",value:function(){window.document.body.removeEventListener("click",this.handleBodyClick)}},{key:"handleBodyClick",value:function(e){var t=e.target,n=(0,c.findDOMNode)(this);(0,d.contains)(n,t)||this.setState({active:!1})}},{key:"handleClick",value:function(e){var t=this.props,n=t.disabled,r=t.children,o=t.type,a=t.mask;if(n!==!0){var i=!0;if("click"===o){if((0,d.contains)((0,c.findDOMNode)(this.refPopup),e.target))return;i=!this.state.active}a&&(0,d.contains)((0,c.findDOMNode)(this.refMask),e.target)&&(i=!1),n===!1&&this.setState({active:i}),r.props.disabled||this.setState({active:i})}}},{key:"handleMouseEnter",value:function(){var e=this.props,t=e.disabled,n=e.children;t!==!0&&(clearTimeout(this.timer),t===!1&&this.setState({active:!0}),n.props.disabled||this.setState({active:!0}))}},{key:"handleMouseLeave",value:function(){var e=this,t=this.props,n=t.disabled,r=t.children;n!==!0&&(clearTimeout(this.timer),n===!1&&(this.timer=setTimeout(function(){e.setState({active:!1})},500)),r.props.disabled||(this.timer=setTimeout(function(){e.setState({active:!1})},500)))}},{key:"render",value:function(){var e=this,t=this.props,n=t.component,r=t.children,o=t.popup,a=t.type,i=t.right,l=t.top,u=t.adjustX,c=t.mask,f=s.default.Children.only(r),h=this.state.active,m={},b={};"focus"===a||"click"===a?m.onClick=(0,d.createChainedFunction)(n.props.onClick,this.handleClick):"hover"===a&&(m.onMouseEnter=(0,d.createChainedFunction)(n.props.onMouseEnter,this.handleMouseEnter),m.onMouseLeave=(0,d.createChainedFunction)(n.props.onMouseLeave,this.handleMouseLeave));var v=Object.assign({},n.props,m);return u&&(i?b.right=u+"px":b.left=u+"px"),s.default.cloneElement(n,Object.assign({},v,{className:(0,p.default)(n.props.className,"gm-trigger"),children:[f,h?s.default.createElement("div",{key:"popup",ref:function(t){return e.refPopup=t},className:(0,p.default)("gm-trigger-popup ",{"gm-trigger-popup-right":i,"gm-trigger-popup-top":l}),style:b},o):null,h&&c&&"hover"!==a?s.default.createElement(y.default,{show:!0,opacity:.2,ref:function(t){return e.refMask=t}}):null]}))}}]),t}(s.default.Component);m.propTypes={type:u.PropTypes.oneOf(["focus","click","hover"]),component:u.PropTypes.element.isRequired,popup:u.PropTypes.element,children:u.PropTypes.element,right:u.PropTypes.bool,top:u.PropTypes.bool,disabled:u.PropTypes.bool,mask:u.PropTypes.bool,adjustX:u.PropTypes.number},m.defaultProps={type:"click",mask:!1},t.default=m},function(e,t){}])});