...
class Picker extends React.Component {
  renderInner () {
    ...
    return (
      <div {...rest} className={classNames('picker-inner')}>
        {_.map(optionGroups, (v, i) => (
          <PickerColumn
            key={i}
            index={i}
            options={v}
        ...
        <div className='picker-highlight border-1px-before border-1px-after' style={highlightStyle}/>
      </div>
    )
  }
